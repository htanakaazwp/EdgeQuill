 ...
 * This file demonstrates how to integrate Edgequill with a web frontend
 */

// For React/Vue/Angular applications
export class EdgequillClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EdgequillClient(provider, contractAddress);
